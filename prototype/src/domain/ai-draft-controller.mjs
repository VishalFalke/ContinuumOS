...
export const AI_DRAFTS = {
  'AI-01': { draftId: 'SYN-AI-01-1001', generatedAt: '2026-07-26T10:30:00+05:30', sourceLinks: ['DiagnosticReport/SYN-DR-6001 v2', 'ServiceRequest/SYN-SR-4001', 'Observation/SYN-OBS-5002'], uncertainty: 'Orientation support only; it does not interpret, diagnose or direct care.', text: 'Orientation draft: Abdominal ultrasound report SYN-DR-6001 version 2 is amended and current. It describes a single approximately 8 mm echogenic focus in the gallbladder with posterior acoustic shadowing and no represented wall thickening or pericholecystic fluid. The report impression is cholelithiasis without sonographic evidence of acute cholecystitis. The assigned Clinic physician must review the report and source evidence before any acknowledgement or follow-up decision.' },
  'AI-02': { draftId: 'SYN-AI-02-1001', generatedAt: '2026-07-26T10:32:00+05:30', sourceLinks: ['EVT-11 SYN-DIR-602-01', 'DiagnosticReport/SYN-DR-6001 v2', 'ServiceRequest/SYN-SR-4001'], uncertainty: 'Operational draft only; destination and required fields need human review.', text: 'Referral handoff draft: The human-approved day-care referral references abdominal ultrasound report SYN-DR-6001 version 2. The report impression is cholelithiasis without sonographic evidence of acute cholecystitis. A Referral Coordinator must verify the destination, required package fields, operational approval and any applicable clinical-content approval before routing. This draft does not create, approve or send the referral.' },
}
