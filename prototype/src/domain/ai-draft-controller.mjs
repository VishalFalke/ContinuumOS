...
export const AI_DRAFTS = {
  'AI-01': { draftId: 'SYN-AI-01-1001', generatedAt: '2026-07-26T10:30:00+05:30', sourceLinks: ['DiagnosticReport/SYN-DR-6001 v2', 'ServiceRequest/SYN-SR-4001', 'Observation/SYN-OBS-5002'], uncertainty: 'Synthetic orientation only; it does not interpret, diagnose or direct care.', text: 'Current source report v2 is available for assigned human review. Verify the source report before acknowledgement.' },
  'AI-02': { draftId: 'SYN-AI-02-1001', generatedAt: '2026-07-26T10:32:00+05:30', sourceLinks: ['EVT-11 SYN-DIR-602-01', 'DiagnosticReport/SYN-DR-6001 v2', 'ServiceRequest/SYN-SR-4001'], uncertainty: 'Synthetic operational draft only; destination and required fields need human review.', text: 'Draft handoff context is source-linked. A Referral Coordinator must complete and approve the package separately.' },
}
